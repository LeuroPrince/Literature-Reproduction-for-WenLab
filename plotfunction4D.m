...
plot(x_ctrl, y_ctrl, 'Color', [0.5,0.5,0.5], 'LineWidth', 1.5, 'DisplayName', 'no ATR (N=52)');
...
plot(x_eat4, y_eat4, 'r', 'LineWidth', 1.5, 'DisplayName', 'eat-4 (N=89)');
...
plot(x_atr, y_atr, 'Color',[0,0,0.5], 'LineWidth', 1.5, 'DisplayName', 'ATR');
