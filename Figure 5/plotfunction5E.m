...
% RIV
[xb_ctrl, yb_ctrl, lb_ctrl, ub_ctrl,xa_ctrl,ya_ctrl,la_ctrl, ua_ctrl] = processData5DE(1:11, '3E-F_5D-E-dataRIV.xlsx', '3E-F_5D-E-time.xlsx','turnstart',plot_length);
%t > 0
...
% RIB-ablated
[xb_ablated, yb_ablated, lb_ablated, ub_ablated,xa_ablated,ya_ablated,la_ablated, ua_ablated] = processData5DE(1:10, 'data5DE.xlsx', 'time5DE.xlsx','turnstart',plot_length);
%t > 0
...
title('RIV and RIB ablated comparision');
xlabel('Time(s)');
ylabel('dR/R0');


axis([-3 3 -0.2 0.6]); % 使用一个能包含所有数据的坐标轴范围
