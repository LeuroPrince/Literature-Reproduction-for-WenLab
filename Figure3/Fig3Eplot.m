...
% RIV
[xb_ctrl, yb_ctrl, lb_ctrl, ub_ctrl,xa_ctrl,ya_ctrl,la_ctrl, ua_ctrl] = processData3EF(1:11, '3E-F_5D-E-dataRIV.xlsx', '3E-F_5D-E-time.xlsx','turnstart',plot_length);
%t > 0
plot(xa_ctrl, ya_ctrl, 'b', 'LineWidth', 1.5, 'DisplayName', 'freely moving');
